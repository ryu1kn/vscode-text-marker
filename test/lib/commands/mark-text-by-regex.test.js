...
const MarkTextByRegexCommand = require('../../../lib/commands/mark-text-by-regex');

suite('MarkTextByRegexCommand', () => {
    ...
    test('it decorates text that matches to the specified regex', () => {
        ...
        const command = new MarkTextByRegexCommand({decorationOperatorFactory, regexReader, vsWindow, logger});
    ...
    test('it does nothing if regex is not given', () => {
        ...
        const command = new MarkTextByRegexCommand({decorationOperatorFactory, regexReader});
    ...
    test('it logs error if an exception occurred', () => {
        ...
        const command = new MarkTextByRegexCommand({logger, regexReader});
